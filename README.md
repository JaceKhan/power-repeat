...
- 선생님 모드
  ...
  - 반별 리딩 본문 과제 생성
  - 반 전체 또는 개별 학생만 골라 배정 (개인 스크립트 배정)
  - 본문 준비 → 반·마감일 → 확인 배정 3단계 배정 흐름
  - 통 배정 / 구간 분할 / 통 반복 모드와 회차별 날짜·구간 미세 조정
  - 달력에서 배정일 클릭, 그 주 일요일까지 제출 가능
  - 배정 후 이어서 다른 본문 추가 배정
  - 본문별 색으로 캘린더 일정 구분
  - 제출률과 과제별 제출 현황 확인
  ...
  - 재제출 요청
- 학생 모드
  - 캘린더로 배정된 숙제·남은 숙제·클리어 숙제 한눈에 확인
  - 학생/반별 과제(회차) 확인
  - 미제출/검토 대기/피드백 완료/재제출 상태를 한눈에 확인
  - 본문과 제출 안내 확인
  ...
  - 제출 상태와 선생님 피드백 확인
  - 제출 등급 A+/A/B 확인
  - A/B로 제출한 숙제는 A+를 위해 다시 듣고 재녹음·재제출 가능
